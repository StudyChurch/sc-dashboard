<template>
	<div class="sc-studio--chapter" v-loading="loading">
...
//      }
    ...
    methods   : {
      removeItem() {
        this.loading = true;
        this.$store
          .dispatch('study/updateStudyChapter', {chapterID: this.study.chapter.id, data: {elements: this.study.chapter.elements.filter(element => element.id !== this.item.id)}})
      ...
      save() {
        ...
        this.loading = true;
        this.$store
          .dispatch('study/updateStudyChapter', {chapterID: this.study.chapter.id, data: {elements: this.study.chapter.elements}})
          .then(response => {
            this.loading = false;
            this.editing = false;
          });
