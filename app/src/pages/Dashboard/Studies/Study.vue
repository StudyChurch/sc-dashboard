    ...
    export default {
        ...
        computed  : {
            ...
            canViewChapter() {
                ...
                if ( this.chapterData.author === this.getMyId ) {
                    return true;
                }
                ...
                if ( 'publish' === this.chapterData.status ) {
                    return true;
                }

                if ( this.chapterData.id === 0 ) {
                    this.chapterData.id = -1;
                    return true;
                }
