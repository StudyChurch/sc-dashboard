<template>
	...
	<div class="sc-group--studies">
		...
		<div class="row">
			<div class="col-12">
				<div class="text-right" v-if="isGroupAdmin() && currentUserCan( 'create_study' )">
					<n-button type="primary" @click.native="handleShowModal">Create Study</n-button>
				</div>

				<modal :show.sync="showModal" headerclasses="justify-content-center" v-if="isGroupAdmin() && currentUserCan( 'create_study' )" v-loading="creatingStudy">
